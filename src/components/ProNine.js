    ...
    <div>
        ...
        <div className='w-[90%] m-auto md:flex justify-evenly items-center'>
            <div className='text-center md:text-left mb-5 md:mb-0 w-96'>
                ...
                <p className='pb-2'>
                    The Rock Cathedral, 4th Roundabout Lekki Epe Expressway, Lagos.
                </p>
                <h1 className='font-bold pb-1'>Client:</h1>
                <p className='pb-2'>Seattle Apartments</p>
                <h1 className='font-bold pb-1'>Contractor:</h1>
                <p className='pb-2'>Kennings Homes</p>
                <h1 className='font-bold pb-1'>Service:</h1>
                <p className='pb-2'>
                    Electrical installation of prayer chapel. Design and installation of cooling system 
                    (Ducted Unit). Design and installation of street light for parking lot. General 
                    maintenance of all electrical power equipment. Installation of 4units of 40KVA smart APC UPS
                </p>
            </div>
