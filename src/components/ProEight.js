    ...
    <div>
        ...
        <div className='w-[90%] m-auto md:flex justify-evenly items-center'>
            <div className='text-center md:text-left mb-5 md:mb-0 w-96'>
                ...
                <p className='pb-2'>
                    King’s court estate, Abijo GRA, Abijo, Lagos.
                </p>
                <h1 className='font-bold pb-1'>Contractor:</h1>
                <p className='pb-2'>LiteVille Engineering Company Ltd.</p>
                <h1 className='font-bold pb-1'>Service:</h1>
                <p className='pb-2'>
                    Electrical and Mechanical infrastructural design and installation. Supply and 
                    Installation of 3MVA power transformer to serve 160 units of mixed residential development.
                    Mechanical infrastructure (Water reticulation, water treatment, borehole and fire hydrant)
                    Estate surveillance system (CCTV)
                </p>
            </div>
